...
if __name__ == '__main__':
    mtcnn_detector = MtcnnDetector(p_model_path="./results/pnet/log_bs512_lr0.010_072402/check_point/model_010.pth",
                                   r_model_path="./results/rnet/log_bs512_lr0.001_072502/check_point/model_010.pth",
                                   o_model_path="./results/onet/log_bs512_lr0.001_072602/check_point/model_010.pth",
                                   min_face_size=24,
