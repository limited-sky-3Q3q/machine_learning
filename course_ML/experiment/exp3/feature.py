...
class NPDFeature():
    ...
    Attributes:
        ...
        n_pixels: An integer indicating the number of image total pixels.  像素总数
        features: A one-dimension ndarray to store the extracted NPD features.  用于存储提取的NPD特征的一维数据库
    """
    __NPD_table__ = None

    def __init__(self, image):
        '''Initialize NPDFeature class with an image.用图像初始化NPDFeature类 '''
